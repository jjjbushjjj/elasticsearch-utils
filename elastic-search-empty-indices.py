...
parser.add_argument('--server', metavar='S', help='elasticsearch server name',
                    required='1', action="store")
parser.add_argument('--port', metavar='P', help='elasticsearch server port',
                    required='1', action="store")
parser.add_argument('--proto', metavar='E', help='https or http',
                    action="store", choices=['http', 'https'],
                    default='http')
parser.add_argument('--user', metavar='u',
                    help='Username if you are using auth', action="store")
parser.add_argument('--password', metavar='p',
                    help='Password if you are using auth', action="store")
parser.add_argument('--delete', metavar='d', help='Delete empty indicies',
                    choices=['yes', 'no'], default='no', action="store")
